...
// https://api.ncloud-docs.com/docs/common-ncpapi
	...
	public void sendSMS(String tel, String rand) {
		...
		String accessKey = "qUX8hIkhJ2YXip4BNlWj";                     	// 네이버 클라우드 플랫폼 회원에게 발급되는 개인 인증키			// Access Key : https://www.ncloud.com/mypage/manage/info > 인증키 관리 > Access Key ID
		String secretKey = "xv83Sl61HnC93lWOK8TxgSt9cwkyrjkl8SIHFh6j";  // 2차 인증을 위해 서비스마다 할당되는 service secret key	// Service Key : https://www.ncloud.com/mypage/manage/info > 인증키 관리 > Access Key ID	
		String serviceId = "ncp:sms:kr:305852960143:festivalolle";       // 프로젝트에 할당된 SMS 서비스 ID							// service ID : https://console.ncloud.com/sens/project > Simple & ... > Project > 서비스 ID
	    ...
	    bodyJson.put("content", "김종원씨 인증번호: " + rand);	// Mandatory(필수), 기본 메시지 내용, SMS: 최대 80byte, LMS, MMS: 최대 2000byte
