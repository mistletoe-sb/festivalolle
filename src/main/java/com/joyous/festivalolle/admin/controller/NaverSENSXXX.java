...
public class NaverSENSXXX {
	...
	public void send_msg(String tel, String rand) {		//String tel, String rand
        ...
        // 개인 인증키
        String accessKey = "qUX8hIkhJ2YXip4BNlWj";
        // 2차 인증을 위해 서비스마다 할당되는 service secret
        String secretKey = "xv83Sl61HnC93lWOK8TxgSt9cwkyrjkl8SIHFh6j";
        // 프로젝트에 할당된 SMS 서비스 ID
        String serviceId = "ncp:sms:kr:305852960143:festivalolle";
        // 요청 method
        String method = "POST";
        ...
        // 난수와 함께 전송
        toJson.put("content",rand);				//"Going 본인인증 ["+rand+"]"
        toJson.put("to", tel);				//tel 을 그냥 넣음
        toArr.add(toJson);
