...
public interface ITicketRepository {
	...
	int countBuyer(
			@Param("organizationCode") int organizationCode, @Param("titleListInput") int titleListInput, @Param("tableBoxInput") String tableBoxInput, @Param("searchInput") String searchInput); //구매자 목록의 행 수
